				...
				<div class="table100 ver1">
					<div class="table100-firstcol">
						<table>
							...
							<tbody>
							<%
								String sql="select * from login_table where DeptId!=1;";
								rs=LogicCore.LoginDetails(sql,"majorproject");							
								while(rs.next())
								{	
							%>
					...
					<div class="wrap-table100-nextcols js-pscroll">
						<div class="table100-nextcols">
							<table>
								...
								%>
									<tr class="row100 body">
										<td class="cell100 column2" ><input type="text" name="id" value="<%=rs.getString(2)%>" readonly="readonly"/></td>
										...
										<td class="cell100 column6"><input type="submit" id="upd" value="Delete" /></td>
									</tr>
								<%} %>
								</tbody>
							</table>
